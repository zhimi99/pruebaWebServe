...
a persistence unit "EvaluacionWSZhiminaicelaPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "EvaluacionWSZhiminaicela\pom.xml":
...
artifact ("EvaluacionWSZhiminaicela.war") is already built. You can build
